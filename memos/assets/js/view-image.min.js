        ...
        this.display = function (a, d) {
            var c = a.indexOf(d),
                e = (new DOMParser)
                    .parseFromString(
                        '\n                <div class="view-image">\n                    <style>.view-i' +
                                ...
                                'ing:10px;border-radius:5px;background:rgba(255,255,255,0.1);margin-bottom:cons' +
                ...
                g = function (f) {
                    ...
                    h[f.key] && e
                        .querySelector(".view-image-" + h[f.key])
                        .click()
                },
                l = function (f) {
                    var h = new Image,
            ...
            e.onclick = function (f) {
                f
                    ...
                    .closest(".view-image-close")
                        ...
                        : f
                            .target
                            .closest(".view-image-tools__flip") && (
